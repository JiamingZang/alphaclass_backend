...
public interface MediaDAO {
    ...
    public int updateMediaById(String new_name,String new_type,int new_asset_id,int new_anchor_id,String style,float color_r,float color_g,float color_b,int id);
